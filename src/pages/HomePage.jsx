...
const HomePage = () => {
  ...
  return (
    <div className="container">
      <InputGroup className="my-3 bg-success text-white">
        <Form.Control
          value={search}
          onChange={(e) => setSearch(e.target.value)}
          placeholder="Searching category"
        />
        <Button className="text-white" variant="outline-secondary" onClick={showModal}>
          Add category
        </Button>
      </InputGroup>
      ...
      <Modal  show={show} onHide={closeModal} backdrop="static" keyboard={false}>
        <Form className="bg-warning" onSubmit={handleSubmit(onSubmit)}>
